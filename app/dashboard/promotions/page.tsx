                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
                        {roomTypes?.map((room) => (
                          ...
                          >
                            <input
                              type="checkbox"
                              checked={newPromotion.roomsIds.includes(
                                room.roomTypeId,
                              )}
                              onChange={() =>
                                handleRoomTypeSelectionChange(room.roomTypeId)
                              }
                            />
                            {room.roomType}
                          </label>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-2">
                          {roomTypes?.map((room) => (
                            ...
                            >
                              <input
                                type="checkbox"
                                checked={editPromotion.roomsIds.includes(
                                  room.roomTypeId,
                                )}
                                onChange={() =>
                                  handleEditRoomTypeSelectionChange(
                                    room.roomTypeId,
                                  )
                                }
                              />
